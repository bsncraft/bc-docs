                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{fontSize: '0.9rem', color: 'var(--ifm-color-emphasis-700)'}}>
                      <strong>Core Tables:</strong> <Link to="/database-schema/customers#customer-master-cusmasa" style={{color: 'var(--ifm-color-primary)', textDecoration: 'none'}}>CUSMASA</Link>, <Link to="/database-schema/customers#contacts-multi-addresses-ivctblu" style={{color: 'var(--ifm-color-primary)', textDecoration: 'none'}}>IVCTBLU</Link><br/>
                      ...
                      Customer master data, multiple addresses and contact information
                    </div>
                  </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{fontSize: '0.9rem', color: 'var(--ifm-color-emphasis-700)'}}>
                      ...
                      <strong>Inventory Lookups:</strong> <Link to="/database-schema/inventory#product-groups-invtbla" style={{color: 'var(--ifm-color-primary)', textDecoration: 'none'}}>INVTBLA</Link>, <Link to="/database-schema/inventory#product-categories-invtblb" style={{color: 'var(--ifm-color-primary)', textDecoration: 'none'}}>INVTBLB</Link>, <Link to="/database-schema/inventory#unit-of-measure-invtblg" style={{color: 'var(--ifm-color-primary)', textDecoration: 'none'}}>INVTBLG</Link><br/>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{fontSize: '0.9rem', color: 'var(--ifm-color-emphasis-700)'}}>
                      ...
                      <strong>Inventory Lookups:</strong> <Link to="/database-schema/inventory#product-categories-invtblb" style={{color: 'var(--ifm-color-primary)', textDecoration: 'none'}}>INVTBLB</Link>, <Link to="/database-schema/inventory#unit-of-measure-invtblg" style={{color: 'var(--ifm-color-primary)', textDecoration: 'none'}}>INVTBLG</Link><br/>
