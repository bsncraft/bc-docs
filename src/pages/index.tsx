                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{fontSize: '0.9rem', color: 'var(--ifm-color-emphasis-700)'}}>
                      ...
                      <strong>Inventory Lookups:</strong> <Link to="/database-schema/lookup-tables#product-groups-invtbla" style={{color: 'var(--ifm-color-primary)', textDecoration: 'none'}}>INVTBLA</Link>, <Link to="/database-schema/lookup-tables#product-categories-invtblb" style={{color: 'var(--ifm-color-primary)', textDecoration: 'none'}}>INVTBLB</Link>, <Link to="/database-schema/lookup-tables#unit-of-measure-invtblg" style={{color: 'var(--ifm-color-primary)', textDecoration: 'none'}}>INVTBLG</Link><br/>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{fontSize: '0.9rem', color: 'var(--ifm-color-emphasis-700)'}}>
                      ...
                      <strong>Inventory Lookups:</strong> <Link to="/database-schema/lookup-tables#product-categories-invtblb" style={{color: 'var(--ifm-color-primary)', textDecoration: 'none'}}>INVTBLB</Link>, <Link to="/database-schema/lookup-tables#unit-of-measure-invtblg" style={{color: 'var(--ifm-color-primary)', textDecoration: 'none'}}>INVTBLG</Link><br/>
